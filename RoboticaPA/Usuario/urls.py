...
urlpatterns = [
    ...
    path('completar-cadastro/<int:pk>', views.completar_cadastro, name="completar_cadastro"),
    path('post/completar-cadastro-usuario', views.completar_cadastro_usuario, name = "completar_cadastro_usuario"),
    path('post/completar-cadastro-interesses', views.completar_cadastro_interesses, name = "completar_cadastro_interesses"),
