"""
Django settings for RoboticaPA project.
...
SECRET_KEY = 'django-insecure-&sp7+vc%%^=8z@#qmz9l@#afrod_#81lvcvtzx^(9e32sqt-66'
...
WSGI_APPLICATION = 'RoboticaPA.wsgi.application'
