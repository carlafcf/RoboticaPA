...
urlpatterns = [
    ...
    path('listar/sugerir-disciplina/', views.sugerir_disciplina, name="sugerir_disciplina"),
    path('listar/sugerir-conteudo/', views.sugerir_conteudo, name="sugerir_conteudo"),
    ...
    path('listar-sugestoes/analisar-disciplinas/', views.analisar_sugestoes_disciplina, name="analisar_disciplinas"),
    path('listar-sugestoes/analisar-conteudos/', views.analisar_sugestoes_conteudo, name="analisar_conteudos"),
